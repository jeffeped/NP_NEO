const CACHE='npp-neo-static-0.2.0';
const FILES=['./','./index.html','./styles.css','./app.js','./engine.js','./alerts.js','./hydration.js','./hydration-ui.js','./pdf.js','./manifest.webmanifest','./vendor/pdf-lib.min.js','./assets/uea-logo.png','./assets/icon-192.png','./assets/icon-512.png','./assets/icon-maskable.png'];
