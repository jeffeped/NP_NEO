const CACHE='npp-neo-static-0.5.0';
const FILES=['./','./index.html','./styles.css','./app.js','./app-update.js','./assets/grow-neo-logo.png','./engine.js','./alerts.js','./standard.js','./standard-ui.js','./standard-pdf.js','./hydration.js','./hydration-ui.js','./pdf.js','./enteral.js','./enteral-ui.js','./enteral-pdf.js','./manifest.webmanifest','./vendor/pdf-lib.min.js','./assets/uea-logo.png','./assets/icon-192.png','./assets/icon-512.png','./assets/icon-maskable.png'];
