...
export async function createStandardReport(result){
  ...
  doc.setTitle('NP padrão - Numeta G13%E');doc.setAuthor('Jefferson Guilherme');doc.setCreator('GROW_NEO by Prof. Jefferson');
  ...
  function newPage(title){page=doc.addPage([595,842]);page.drawImage(logo,{x:42,y:779,width:170,height:170*logo.height/logo.width});text('GROW_NEO by Prof. Jefferson',300,789,10,bold);text('NP padrão - Numeta G13%E',42,749,16,bold);text(title,42,726,10);y=702;}
